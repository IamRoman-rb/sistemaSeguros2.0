                ...
                <article className={Style.card}>
                    ...
                    <div className={Style.cardBody}>
                        ...
                        <div className={Style.datoRow}>
                            ...
                            <span style={{ color: poliza.valido ? 'green' : 'red', fontWeight: 'bold' }}>
                ...
                {vehiculo && (
                    <article className={Style.card}>
                        ...
                        <div className={Style.cardBody}>
                            ...
                            <div className={Style.datoRow}>
                                <span className={Style.label}>N Chasis:</span>
                                <span className={Style.valor}>{vehiculo.chasis}</span>
                            </div>
                            <div className={Style.datoRow}>
                                <span className={Style.label}>N Motor:</span>
                ...
                <div className={Style.tableResponsive}>
                        ...
                        <tbody>
                            {pagos.map((pago) => (
                                <tr key={pago.id}>
                                    ...
                                    <td>
                                        <span className={Style.badgeMetodo}>
                                            {metodos.find(m => m.id === pago.id_metodo)?.metodo || "Desconocido"}
                                        </span>
                                    </td>
                                    <td style={{ color: 'var(--slate-grey)', fontSize: '0.9em' }}>
                                        {pago.observacion || "-"}
                                    </td>
                                    <td style={{textAlign: 'right', fontWeight: '600', color: 'var(--deep-twilight)'}}>
                                        {formatCurrency(pago.importe)}
                                    </td>
                                    <td>
                                        <Link to={`/admin/pagos/detalle/${pago.id}`} className={Style.linkDetalle}>
                                            <IconFileCertificate size={18} /> Ver Detalle
                                        </Link>
                                    </td>
                                </tr>
                            ))}
                    ...
                    {pagos.length === 0 && (
                        <p style={{padding: '2rem', textAlign: 'center', color: 'var(--slate-grey)', fontStyle: 'italic'}}>
                            No se han registrado pagos para esta póliza.
                        </p>
                    )}
                </div>
            </section>
